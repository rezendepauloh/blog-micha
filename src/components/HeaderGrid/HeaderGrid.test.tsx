...
describe('<HeaderGrid />', () => {
  it('should render Logo and Main Menu Nav', () => {
    const { container } = renderTheme(
      <HeaderGrid links={linksMock} logoData={logoData} />,
    );
  ...
  it('should render menu mobile and button for open and close the menu', () => {
    renderTheme(<HeaderGrid links={linksMock} logoData={logoData} />);
  ...
  it('should not render links', () => {
    const { container } = renderTheme(<HeaderGrid logoData={logoData} />);
    expect(
