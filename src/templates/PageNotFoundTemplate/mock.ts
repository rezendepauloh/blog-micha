...
import mock from 'components/PageNotFound/mock';

export const mockPageNotFoundTemplateWithImage = {
  pageNotFound: {
    title: mock.title,
    html: mock.html,
  },
...
} as PageNotFoundTemplateProps;

export const mockPageNotFoundTemplateWithoutImage = {
  pageNotFound: {
    title: mock.title,
    html: mock.html,
  },
